...
declare module _ {
    ...
    interface LoDashStatic {
        matches<T>(a: Array<T>): (v:T) => boolean;
    }
    ...
    **********/
    ...
    interface LoDashObjectWrapper<T> {
        ...
        * @see _.values()
        **/
        values<TValue>(): LoDashArrayWrapper<TValue>;
    }
    ...
    interface LoDashObjectWrapper<T> {
         ...
         * @see _.mapValues()
         **/
        mapValues<TValue>(callback: ObjectIterator<TValue, TValue>, thisArg?: any): LoDashObjectWrapper<TValue>;
